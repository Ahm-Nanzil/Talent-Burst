            ...
            <div class="row form-group">
              ...
              <div class="row form-group">
                <div class="col-md-12 text-right" >
                    <p class="mb-0">Don't have an account? <a href="#" id="showSignupLink" >Sign Up</a></p>
                </div>
            </div>

            </form>

            <form action="signup.php" class="p-4 border rounded" id="signupForm" style="display: none;">

              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="text-black" for="fname">Email</label>
                  <input type="text" id="emailSignup" class="form-control" placeholder="Email address">
                </div>
              </div>
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="text-black" for="fname">Password</label>
                  <input type="password" id="passwordSignup" class="form-control" placeholder="Password">
                </div>
              </div>
              <div class="row form-group mb-4">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="text-black" for="fname">Re-Type Password</label>
                  <input type="password" id="confirmPassword" class="form-control" placeholder="Re-type Password">
                </div>
              </div>
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="text-black" for="fname">Role</label>
                  <input type="text" id="roleSignup" class="form-control" placeholder="Give you role here">
                </div>
              </div>

               <!-- Response Message Container -->
    <div id="responseMessage" class="text-danger mb-3"></div>
              ...
              <div class="row form-group">
                <div class="col-md-12 text-right" >
                    <p class="mb-0">Already have an account? <a href="#" id="showLoginLink">Login</a></p>
                </div>
            </div>
